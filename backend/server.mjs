...
// POST /api/signup - Create a new auth record and analysis row.
...
// POST /api/customer-response - Get a customer response.
...
// POST /api/analysis - Analyze transcript and update user's record.
